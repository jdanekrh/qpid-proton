...
// Don't do this with libc++, on MacOS, FreeBSD or with Visual Studio
#if !defined(_LIBCPP_VERSION) && !defined(_MSC_VER) && !(defined(__APPLE__) && defined(__MACH__)) && !defined(__FreeBSD__)
