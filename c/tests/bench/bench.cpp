...
static void sender_handle(app_data_t *app, pn_event_t *event);

// stdout
void stdoutlogger(const char *message) {
    printf("%s\n", message);
}
...
//            pn_transport_trace(receiver.transport, PN_TRACE_FRM | PN_TRACE_EVT);
//            pn_transport_trace(sender.transport, PN_TRACE_FRM | PN_TRACE_EVT);
